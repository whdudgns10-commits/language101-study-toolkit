...
A production-ready, mobile-first activity hub for Language101 meetups. Participants can scan a QR code, search or filter 20 activities, save favorites on their device, and open the original material without creating an account.
