  ...
  return <>
    ...
    <main className="detail-page compact-activity-detail"><div className="detail-shell">
      ...
      <article className="detail-card">
        ...
        <div className="compact-detail-meta"><span>{t("activity.level")} · <b>{levelLabel}</b></span><span><Clock3/>{activity.id === "debate-pros-cons" ? "20–40" : activity.id === "funny-questions" ? "15–40" : activity.durationMinutes} min</span><span><Users/>{activity.groupSizes.join(", ")}</span>{activity.id === "funny-questions"&&<span>500 Questions</span>}</div>
