...
import { Brain, CircleHelp, Lightbulb, ListChecks, MessagesSquare, NotebookPen, Scale, Smile, Sparkles, Swords, Users } from "lucide-react";
...
function BalanceTwoIcon(){return <span className="activity-icon-composite"><Scale aria-hidden="true"/><b>2</b></span>}
...
const activityIcons:Record<ActivityIconKey,DecorativeIcon> = {
  ...
  guessing:Brain, battle:Swords, balance:Scale, "balance-2":BalanceTwoIcon,
