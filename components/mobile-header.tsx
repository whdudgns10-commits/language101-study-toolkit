...
export function MobileHeader(){const {t}=useLanguage();return <header className="mobile-header"><Link href="/" className="mobile-brand" aria-label={t("common.home")}><span>L1</span><b>{t("brand.name")}<br/><em>{t("brand.subtitle")}</em></b></Link><nav><MissionHeaderButton/><Link href="/my-study" className="my-study-header-link" data-tutorial="my-study" aria-label={t("nav.myStudy")}><UserRound/><small>{t("nav.myStudy")}</small></Link><Link href="/activities?focus=search" aria-label={t("common.search")}><Search/></Link><TutorialHelpButton/><LanguageSelector/></nav></header>}
