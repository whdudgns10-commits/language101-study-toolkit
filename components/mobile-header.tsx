...
export function MobileHeader(){return <header className="mobile-header"><Link href="/" className="mobile-brand"><span>L1</span><b>Language101<br/><em>Study Toolkit</em></b></Link><nav><MissionHeaderButton/><Link href="/my-study" className="my-study-header-link" aria-label="My Study"><UserRound/><small>My Study</small></Link><Link href="/activities?focus=search" aria-label="활동 검색"><Search/></Link></nav></header>}
