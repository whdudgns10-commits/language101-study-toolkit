...
export function LanguageSelector(){
  ...
  return <div className="language-selector" ref={ref}>
    <button type="button" className="language-trigger" aria-label="Select language" aria-haspopup="menu" aria-expanded={open} aria-controls="language-menu" onClick={toggleLanguageMenu}><Globe2 aria-hidden="true"/><span>{languageCodes[language]}</span></button>
