...
export const getActivityContent=(activityId:string)=>["conversation-starter","ice-breaking-3"].includes(activityId)?localTopics:allConversationContent.filter(item=>item.activityIds.includes(activityId));
