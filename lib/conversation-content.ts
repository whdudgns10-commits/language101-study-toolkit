...
export const getActivityContent=(activityId:string)=>activityId==="conversation-starter"?localTopics:allConversationContent.filter(item=>item.activityIds.includes(activityId));
