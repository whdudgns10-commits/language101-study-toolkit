...
const ko:Record<string, { title:string; description:string; instructions?:string[] }> = {
  ...
  "balance-game":{ title:"밸런스 게임", description:"A와 B 중 하나를 선택하고 이유를 설명하며 함께 대화해보세요." },
  "conversation-starter":{ title:"대화 주제 뽑기", description:"질문 하나를 골라 바로 대화를 시작하세요." },
...
const shortTitles:Record<SupportedLanguage, Record<string,string>> = {
  en:{},
  ko:{ "true-or-false":"진실/거짓", "30-second-speaking":"30초 말하기", "20-questions":"스무고개", "what-if-challenge":"만약에", "funny-questions":"재미 질문", "ice-breaking-3":"아이스브레이크", "fun-discuss":"재미 토론", "guessing-words":"단어 맞히기", "word-battle":"단어 배틀", "balance-game":"밸런스 게임", "conversation-starter":"대화 주제", "words-game":"알파벳 게임", "debate-pros-cons":"찬반 토론", "choose-one-out-of-three":"하나 고르기", "useful-expressions":"유용한 표현", "describing-picture-game":"상황 문장" },
  zh:{ "true-or-false":"真假游戏", "30-second-speaking":"30秒表达", "20-questions":"20个问题", "what-if-challenge":"如果挑战", "funny-questions":"趣味问题", "ice-breaking-3":"破冰问题", "fun-discuss":"趣味讨论", "guessing-words":"猜单词", "word-battle":"单词对战", "balance-game":"二选一游戏", "conversation-starter":"对话话题", "words-game":"字母挑战", "debate-pros-cons":"正反辩论", "choose-one-out-of-three":"三选一", "useful-expressions":"实用表达", "describing-picture-game":"情境造句" },
  ja:{ "true-or-false":"真実か嘘", "30-second-speaking":"30秒トーク", "20-questions":"20の質問", "what-if-challenge":"もしも", "funny-questions":"面白い質問", "ice-breaking-3":"アイスブレイク", "fun-discuss":"楽しい討論", "guessing-words":"単語当て", "word-battle":"単語バトル", "balance-game":"二択ゲーム", "conversation-starter":"会話トピック", "words-game":"文字チャレンジ", "debate-pros-cons":"賛否討論", "choose-one-out-of-three":"三択", "useful-expressions":"便利な表現", "describing-picture-game":"英文作り" },
};

const titles:Partial<Record<SupportedLanguage, Record<string,string>>> = {
  zh:{ "true-or-false":"真假游戏", "30-second-speaking":"30秒英语表达", "20-questions":"20个问题", "what-if-challenge":"如果挑战", "funny-questions":"趣味问题", "ice-breaking-3":"破冰问题", "fun-discuss":"趣味讨论", "guessing-words":"猜单词", "word-battle":"单词对战", "balance-game":"二选一游戏", "conversation-starter":"对话话题", "words-game":"5秒字母挑战", "debate-pros-cons":"正反方辩论", "choose-one-out-of-three":"三选一", "useful-expressions":"实用表达", "describing-picture-game":"情境造句游戏" },
  ja:{ "true-or-false":"真実か嘘か", "30-second-speaking":"30秒スピーキング", "20-questions":"20の質問", "what-if-challenge":"もしもチャレンジ", "funny-questions":"面白い質問", "ice-breaking-3":"アイスブレイク質問", "fun-discuss":"楽しいディスカッション", "guessing-words":"単語当て", "word-battle":"単語バトル", "balance-game":"二択ゲーム", "conversation-starter":"会話トピック", "words-game":"5秒アルファベットチャレンジ", "debate-pros-cons":"賛否討論", "choose-one-out-of-three":"三つから一つ", "useful-expressions":"便利な表現", "describing-picture-game":"シチュエーション英文作り" },
};
