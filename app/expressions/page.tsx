...
export default function ExpressionsPage(){return <main className="subpage"><PageHeader title="오늘의 영어표현" description="초급·중급·상급 표현을 매일 하나씩 배워보세요."/><DailyExpressionTabs/></main>}
